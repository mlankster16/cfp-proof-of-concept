...
(function () {
  ...
  var QUESTIONS = [
    { id: 'track', q: 'Which priority track fits your idea best?', help: 'Tracks are reviewed in order, starting with Priority 1.',
      options: [
        { label: 'Priority 1: Responsible and sustainable AI', level: 'ready', note: 'Your idea fits Priority 1, the highest priority for this call. The incentive is $45,000. Remember that one of the three Courses focuses on sustainable AI, green AI, or sustainable governance of AI.' },
        { label: 'Priority 2: A Coursera high-demand topic', level: 'ready', note: 'Your idea fits Priority 2. The incentive is $40,000. Your proposal will need to name the topic it aligns with.', link: ['high-demand-topics.html', 'See the high-demand topics list'] },
        { label: 'Priority 3: AI within a professional field', level: 'ready', note: 'Your idea fits Priority 3. The incentive is $30,000. Proposals for any field are welcome.' },
